...
class FileCollector:    
    ...
    """
    def __init__(self, path_file_to_export, name_file_to_export):
        self.file_path = path_file_to_export
...
class Exporter:
    """
    Gets the file info from the FileCollector attributes.
...
class Export:
    ...
    # Will be in the validator class
