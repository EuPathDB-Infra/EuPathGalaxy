...
document.getElementById("eupath-workflows").innerHTML = "" +
        ...
        "<h4>RNA-Seq</h4>" +
        "<p title=\"Click to run the workflow with your datasets\"><a id='workflow9' href='javascript:void(0)' onClick='import_and_run_workflow(\"7f4214a6361b472d\")'>EuPathDB RNA-Seq paired-end strand-specific: for RNAseq Export Tool</a><br>" +
        "This workflow generates BigWig and Expression fils that are compatible with the EuPathDB RNAseq Export Tool. <a href='https://eupathdb.org/assets/GalaxyRNASeqExportTool.pdf' target='_blank'>Explore this tutorial to learn more.</a><br>Tools: FASTQ Groomer, Trimmomatic, HISAT2, bamCoverage, htseq-count, HTSeqCountToFPKM, Zip Collection</p>" +
        "<p title=\"Click to run the workflow with your datasets\"><a id='workflow9' href='javascript:void(0)' onClick='import_and_run_workflow(\"b8a14a696c13c285\")'>EuPathDB RNA-Seq paired-end unstranded: for RNAseq Export Tool</a><br>" +
        "This workflow generates BigWig and Expression fils that are compatible with the EuPathDB RNAseq Export Tool. <a href='https://eupathdb.org/assets/GalaxyRNASeqExportTool.pdf' target='_blank'>Explore this tutorial to learn more.</a><br>Tools: FASTQ Groomer, Trimmomatic, HISAT2, bamCoverage, htseq-count, HTSeqCountToFPKM, Zip Collection</p>" +
        "<p title=\"Click to run the workflow with your datasets\"><a id='workflow9' href='javascript:void(0)' onClick='import_and_run_workflow(\"e07b26b1c7781e14\")'>EuPathDB RNA-Seq unpaired strand-specific: for RNAseq Export Tool</a><br>" +
        "This workflow generates BigWig and Expression fils that are compatible with the EuPathDB RNAseq Export Tool. <a href='https://eupathdb.org/assets/GalaxyRNASeqExportTool.pdf' target='_blank'>Explore this tutorial to learn more.</a><br>Tools: FASTQ Groomer, Trimmomatic, HISAT2, bamCoverage, htseq-count, HTSeqCountToFPKM, Zip Collection</p>" +
        "<p title=\"Click to run the workflow with your datasets\"><a id='workflow9' href='javascript:void(0)' onClick='import_and_run_workflow(\"5514d6a246152e4b\")'>EuPathDB RNA-Seq unpaired unstranded: for RNAseq Export Tool</a><br>" +
        "This workflow generates BigWig and Expression fils that are compatible with the EuPathDB RNAseq Export Tool. <a href='https://eupathdb.org/assets/GalaxyRNASeqExportTool.pdf' target='_blank'>Explore this tutorial to learn more.</a><br>Tools: FASTQ Groomer, Trimmomatic, HISAT2, bamCoverage, htseq-count, HTSeqCountToFPKM, Zip Collection</p>" +
