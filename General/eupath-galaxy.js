...
document.getElementById("eupath-workflows").innerHTML = "" +
        ...
        "<h4>RNA-Seq</h4>" +
        "<p title=\"Click to run the workflow with your datasets\"><a id='workflow9' href='javascript:void(0)' onClick='import_and_run_workflow(\"a932d4a0226e679a\")'>EuPathDB RNA-Seq paired-end strand-specific: for RNAseq Export Tool</a><br>" +
        ...
        "<p title=\"Click to run the workflow with your datasets\"><a id='workflow9' href='javascript:void(0)' onClick='import_and_run_workflow(\"a932d4a0226e679a\")'>EuPathDB RNA-Seq paired-end unstranded: for RNAseq Export Tool</a><br>" +
        "This workflow generates BigWig and Expression fils that are compatible with the EuPathDB RNAseq Export Tool. <a href='https://eupathdb.org/assets/GalaxyRNASeqExportTool.pdf' target='_blank'>Explore this tutorial to learn more.</a><br>Tools: FASTQ Groomer, Trimmomatic, HISAT2, bamCoverage, htseq-count, HTSeqCountToFPKM, Zip Collection</p>" +
        "<p title=\"Click to run the workflow with your datasets\"><a id='workflow9' href='javascript:void(0)' onClick='import_and_run_workflow(\"a932d4a0226e679a\")'>EuPathDB RNA-Seq unpaired strand-specific: for RNAseq Export Tool</a><br>" +
        "This workflow generates BigWig and Expression fils that are compatible with the EuPathDB RNAseq Export Tool. <a href='https://eupathdb.org/assets/GalaxyRNASeqExportTool.pdf' target='_blank'>Explore this tutorial to learn more.</a><br>Tools: FASTQ Groomer, Trimmomatic, HISAT2, bamCoverage, htseq-count, HTSeqCountToFPKM, Zip Collection</p>" +
        "<p title=\"Click to run the workflow with your datasets\"><a id='workflow9' href='javascript:void(0)' onClick='import_and_run_workflow(\"a932d4a0226e679a\")'>EuPathDB RNA-Seq unpaired unstranded: for RNAseq Export Tool</a><br>" +
        "This workflow generates BigWig and Expression fils that are compatible with the EuPathDB RNAseq Export Tool. <a href='https://eupathdb.org/assets/GalaxyRNASeqExportTool.pdf' target='_blank'>Explore this tutorial to learn more.</a><br>Tools: FASTQ Groomer, Trimmomatic, HISAT2, bamCoverage, htseq-count, HTSeqCountToFPKM, Zip Collection</p>" +
